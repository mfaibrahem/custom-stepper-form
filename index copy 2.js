...
UInextBtn.addEventListener('click', e =>
	handleNextClick(
		UIcurrentStep,
		UIcurrentStepInputs,
		UIcurrentStepTextareas,
		UIcurrentStepSelectors,
		stepErrorsObj,
		e
	)
);
...
for (let singleStep of UISteps) {
	handleSingleStep(singleStep);
}

function handleSingleStep(singleStep) {
	console.log(UIcurrentStepInputs);
